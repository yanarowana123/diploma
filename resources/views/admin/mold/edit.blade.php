...
@section('content')
    ...
    <div class="card">
        ...
        <form method="POST" action="{{route('admin.mold.update',$treePollen)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="control">
                        <input type="text"
                               class="form-control @error('mold_level') is-invalid @enderror"
                               name="mold_level"
                               id="mold_level"
                               value="{{old('mold_level')??$treePollen->mold_level}}"
                               required>
                    </div>
                </div>
